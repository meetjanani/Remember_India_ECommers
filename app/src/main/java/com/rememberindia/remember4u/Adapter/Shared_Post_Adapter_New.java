...
import com.rememberindia.remember4u.Activity.VideoViewActivity;
        ...
        holder.Btn_Play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Records.get(i).getFlag().equals("Video")){
                    ...
                    in.putExtra("Message_1", Records.get(i).getMessage_1());
                    context.startActivity(in);
                } else {
                    Intent appIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Records.get(i).getyouTubeAppIntent()));
