...
public class Order_Summery_Db_Helper extends SQLiteOpenHelper {
    ...
    private static final String EX_GST_MRP = "EX_GST_MRP";
    private static final String GST_MRP = "GST_MRP";
    ...
    public void addOrder(Order_Summery_Ofline_Bean order_items, String item__id) {
        ...
        cv.put(GST_Percentage, order_items.getGST_Percentage());
        cv.put(EX_GST_MRP, order_items.getEX_GST_MRP());
        cv.put(GST_MRP, order_items.getGST_MRP());
    ...
    public List<Order_Summery_Ofline_Bean> getAllOrder() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                order.setGST_Percentage(cursor.getString(6));
                order.setEX_GST_MRP(cursor.getString(7));
                order.setGST_MRP(cursor.getString(8));
                order.setVarient_name(cursor.getString(9));
