...
import com.rememberindia.remember4u.Utility.Utils;
...
public class Product_List_Activity extends AppCompatActivity {
   ...
   // private SearchView searchView;
    ...
    Product_Category_Display_Adapter adapter;
        ...
        call.enqueue(new Callback<Product_List_Bean>() {
            ...
            public void onResponse(Call<Product_List_Bean> call, Response<Product_List_Bean> response) {
                if (response.body().getStatus() == 1)
                {
                    ...
                    adapter = new Product_Category_Display_Adapter(Product_List_Activity.this, Records, "");
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager((Product_List_Activity.this)));
    ...
    public void Search_Filter_Data(String Filter_Type)
    {
        Filtered_Records = new ArrayList<Product_Details_Bean>();
            ...
            adapter = new Product_Category_Display_Adapter(Product_List_Activity.this, Filtered_Records , "");
            recyclerView.setAdapter(adapter);
