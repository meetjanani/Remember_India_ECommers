...
import com.rememberindia.shoppingportal.Utility.TouchImageView;
...
public class Image_Details_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image__details_);
    ...
    private void requestStoragePermission() {
        Dexter.withActivity(Image_Details_Activity.this)
                .withPermissions(
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            (new saveImage(Image_Details_Activity.this)).execute(str_image);
                        }
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Image_Details_Activity.this);
    ...
    public class saveImage extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                MediaScannerConnection.scanFile(Image_Details_Activity.this, as, null, new android.media.MediaScannerConnection.OnScanCompletedListener() {
