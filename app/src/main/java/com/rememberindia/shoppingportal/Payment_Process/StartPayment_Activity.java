...
public class StartPayment_Activity extends AppCompatActivity {

    PayUmoneySdkInitializer.PaymentParam.Builder builder = new PayUmoneySdkInitializer.PaymentParam.Builder();
    PayUmoneySdkInitializer.PaymentParam paymentParam = null ;

    String TAG ="mainActivity", txnid ="txt12346", amount ="20", phone ="9510443624",
            prodname ="Aedit Bar 125 g", firstname ="Meet", email ="meetjanani47@gmail.com",
            merchantId ="6761999", merchantkey="i6XSlBGV";  //   first test key only


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_start_payment_);
    ...
    public void startpay(){
        ...
        Toast.makeText(this, "Start Pay", Toast.LENGTH_SHORT).show();
    ...
    public void getHashkey(){
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                // Toast.makeText(StartPaymentActivity.this, response.body()+ "", Toast.LENGTH_SHORT).show();
                Log.e(TAG, "hash res "+response.body());
                String merchantHash= response.body();
                if (merchantHash.isEmpty() || merchantHash.equals("")) {
                    Toast.makeText(StartPayment_Activity.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
                    ...
                    PayUmoneyFlowManager.startPayUMoneyFlow(paymentParam, StartPayment_Activity.this, R.style.AppTheme_default, false);
                }
            }
