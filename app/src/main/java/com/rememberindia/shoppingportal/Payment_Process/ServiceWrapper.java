...
public class ServiceWrapper {
    ...
    public Retrofit getRetrofit(Interceptor mInterceptorheader) {
        ...
        builder.connectTimeout(Constant_For_Payment.API_CONNECTION_TIMEOUT, TimeUnit.SECONDS);
        builder.readTimeout(Constant_For_Payment.API_READ_TIMEOUT, TimeUnit.SECONDS);
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constant_For_Payment.BASE_URL)
